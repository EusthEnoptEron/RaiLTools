...
namespace RaiLTools.RScript
{
    ...
    public class CommandToken
    {
        ...
        public CommandToken(int index, ushort value)
        {
            Index = index;
            Value = value;
        }
    ...
    public class CommandTokenizer
    {
        ...
        private int ReadInt32(ref int index)
        {
        ...
        private short ReadInt16(ref int index)
        {
        ...
        private short ReadInt16AsInt32(ref int index)
        {
            return ReadInt16(ref index);
        }

        private int ReadInt32_takeLower16(ref int index)
        {
            int value = ReadInt16(ref index);
            ReadInt16(ref index); // Throw away
            return value;
        }
        ...
        public IEnumerable<CommandToken> Enumerate()
        {
            ...
            while (pointer <= _Array.Length - 2)
            {
                ushort int16_controlNo = (ushort)ReadInt16(ref pointer);
                CommandToken token = new CommandToken(pointer - 2, int16_controlNo);
                // if ( !isImage )
                ...
                if ((int16_controlNo & 0xF000) > 0)
                {
                    ...
                    if (v1 > 0x8000)
                    {
                        if (v1 > 49152)
                        {
                            ...
                            {
                                case 53248:
                                    token.AddParam(ReadInt16(ref pointer));
                                    token.AddParam(ReadInt16AsInt32(ref pointer));
                                    token.AddParam(ReadInt16AsInt32(ref pointer));
                ...
                else
                {
                    ...
                    {
                        case 3:
                            token.AddParam(ReadInt32(ref pointer));
                            // sub_41BC90(v47);
                        ...
                        case 0xB:
                            ...
                            break;
                        case 0xC:
                            token.AddParam(ReadInt32_takeLower16(ref pointer));
                            //// token.AddParam(v51)
                            token.AddParam(ReadInt32(ref pointer));
                        ...
                        case 0xD:
                            ...
                            break;
                        case 0xE:
                            int word_49DEB8 = ReadInt16(ref pointer);
                            token.AddParam(ReadInt32(ref pointer));
                            //v56 = // sub_413AC0(v55);
                            // sub_41D7E0(&v484, v56);
                            int dword_49DED4 = ReadInt32(ref pointer);
                            int dword_49DED8 = ReadInt32(ref pointer);
                            int dword_49DEDC = ReadInt32(ref pointer);
                            int dword_49DEE0 = ReadInt32(ref pointer);
                            int dword_49DEE4 = ReadInt32(ref pointer);
                            token.AddParam(ReadInt32(ref pointer));
                            //v58 = // sub_413AC0(v57);
                            // sub_41D7E0(&v485, v58);
                            token.AddParam(ReadInt32(ref pointer));
                        ...
                        case 0x17:
                            ...
                            token.AddParam(ReadInt32_takeLower16(ref pointer));
                            // token.AddParam(v128);
                            ReadInt32_takeLower16(ref pointer);
                            ReadInt32_takeLower16(ref pointer);
